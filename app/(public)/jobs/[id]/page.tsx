...
export default async function JobDetailPage({
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0F] text-white">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pb-28 lg:pb-8 space-y-8 sm:space-y-10">
        <section
          className="
            ...
            before:bg-linear-to-r before:from-cyan-500/10 before:via-purple-500/10 before:to-pink-500/10
            before:opacity-70
            px-5 py-6 sm:px-8 sm:py-8 lg:px-10 lg:py-10
          "
        >
          <div className="relative z-10 w-full min-w-0 flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between"
          >
             <div className="w-full min-w-0 flex flex-col sm:flex-row gap-5 sm:items-start flex-1"
             >
              <Image
              ...
              <div className="flex-1 min-w-0 w-full">
                ...
                <p className="text-cyan-400 font-semibold mt-3 text-lg">
                  {job.salary}
                </p>
        ...
        <section className="w-full min-w-0 grid lg:grid-cols-[2fr_1fr] gap-8">
          ...
          >
            ...
            <p className="mt-4">Open Positions: 8</p>
      ...
      {/* MOBILE APPLY BAR */}
      <div className="lg:hidden fixed bottom-0 inset-x-0 bg-[#0A0A0F]/95 border-t border-white/10 p-4"
      >
        <ApplicationModal 
          jobTitle={job.title} 
          jobId={job.id}
