            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-xl bg-black/10 dark:bg-white/10 border border-white/10 flex items-center justify-center shadow-inner"
                  >
                    <Image
                      src={company.logo}
                      alt={company.name}
                  ...
                  <div>
                    <p className="text-[var(--text-primary)] dark:text-white font-semibold">
                      {company.name}
                    </p>
