...
const EmployerApplicationsPage = () => {
  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#0A0A0F] text-white px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
              ...
              {columns.map((column) => {
                ...
                return (
                  <div
                    ...
                    className="w-[280px] sm:w-[320px] xl:w-auto flex-shrink-0 rounded-[2rem] border border-white/10 bg-white/[0.03] p-4 backdrop-blur-xl min-h-[420px] sm:min-h-[500px]"
                  >
                    ...
                    <div className="space-y-4">
                      {apps.map((app) => (
                        <motion.div
                          ...
                          whileHover={{ y: -2 }}
                          className="cursor-grab rounded-3xl border border-white/10 bg-black/30 p-4 sm:p-5 transition hover:border-cyan-500/20 active:cursor-grabbing"
                        >
        ...
        {/* LIST VIEW */}
        {view === 'list' && (
          <section className="overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.03] backdrop-blur-xl">
